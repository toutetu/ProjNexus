...
大手企業では、申請業務・開発の進捗管理・予算管理などが、それぞれ別々の方法で行われていることがあります。
このアプリは、これらの業務を一つの画面にまとめ、手作業による事務負担を減らしながら、進捗や予算、業績を把握しやすくすることを目的としています。

経理・管理会計・事業推進の仕事で培った業務知識をもとに、
**「どんなデータが必要か」「誰が何を操作できるか」「どうすれば使いやすいか」**を考え、データ設計・権限管理・画面設計から実装まで行った業務Webアプリです。
